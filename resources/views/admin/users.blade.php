    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('admin.members')}}" class="nav-link active">
                  ...
                  <table class="table table-striped m-0">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="{{route('admin.users.update',['user'=>$member->id, 'status'=>'verify'])}}" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-success">Verify</a>
                          @endif
